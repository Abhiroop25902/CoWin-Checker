...
specific_center_ids = [695695, 694629, 614417, 597000]
specific_pin_codes = [400013, 400028, 400016, 400016]
specific_names = ["The World Tower MCGM Parkg",
                  "KOHINOOR PUB PARKING (DRIVE)", "Mahim Municipal Maternity Home", "P D Hinduja 1"]
